...
    { href: "https://www.behance.net/jermainemckenna1", label: "Behance", text: "Be" },
...
              {/* Make each link consistent so “Services” can’t drift */}
...
                    key={href}
                    href={href}
                    className="inline-flex items-center leading-none hover:text-slate-50"
                  >
                    {label}
                  </Link>
                ))}
...
                      item.icon
                    ) : (
                      <span className="pointer-events-none text-xs font-semibold">Be</span>
                    )}
                  </a>
                ))}
              </div>
