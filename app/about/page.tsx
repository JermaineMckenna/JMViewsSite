      ...
      <section className="bg-slate-950">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
            JMViews is a one-person digital studio exploring web, visuals and
            motion.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
              {/* subtle emerald line (matches site accents) */}
              ...
              <h2 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-400">
                <span className="inline-flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_18px_rgba(52,211,153,0.6)]" />
                  Approach
                </span>
              </h2>
              ...
              <p className="mt-3 text-sm text-slate-300">
                As the portfolio grows, JMViews becomes a record of that
                journey: travelling to capture new material, experimenting with
                motion and 3D, and building projects that mix those disciplines
                in a way that still feels clean and usable.
              </p>
            </div>
