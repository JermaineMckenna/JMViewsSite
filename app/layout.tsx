...
  metadataBase: new URL("https://jm-views-site.vercel.app/"),
...
function IconTikTok() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="block h-4 w-4" fill="currentColor">
...
              <nav className="grid w-full grid-cols-2 gap-x-6 gap-y-2 text-sm text-slate-300 sm:w-auto sm:grid-cols-none sm:auto-cols-max sm:grid-flow-col sm:items-center sm:justify-end sm:gap-x-5">
...
                    className="grid h-9 w-9 place-items-center rounded-full border border-slate-700 bg-slate-900/60 text-slate-200
