...
                {/* Common button style for all socials */}
                {/* Instagram */}
                <a
...
                  className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-700 bg-slate-900/60 hover:border-emerald-500/70 hover:bg-slate-900 transition"
                >
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 24 24"
