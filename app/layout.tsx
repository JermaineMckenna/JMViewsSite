...
              {/* FIX: prevent “Services” drifting by enforcing consistent height + wrapping rules */}
              <nav className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-slate-300 sm:flex-nowrap">
                {[
                  ["Services", "/services"],
                  ["Portfolio", "/portfolio"],
                  ["About", "/about"],
...
                    key={href}
                    href={href}
                    className="inline-flex items-center px-1 py-1 leading-none hover:text-slate-50"
                  >
                    {label}
                  </Link>
                ))}
...
              {/* Social links (fast + stable hover) */}
...
                    className="inline-grid h-9 w-9 place-items-center rounded-full border border-slate-700 bg-slate-900/60 text-slate-200
