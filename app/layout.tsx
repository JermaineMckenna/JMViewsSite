...
                    className="group inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-700 bg-slate-900/60 text-slate-200 transition hover:border-emerald-400 hover:text-emerald-400 hover:shadow-[0_0_20px_rgba(52,211,153,0.35)] focus:outline-none focus:ring-2 focus:ring-emerald-500/60"
                  >
                    {item.icon ? (
